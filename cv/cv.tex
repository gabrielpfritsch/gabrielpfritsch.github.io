...
\noindent
\begin{tabular}{@{} l @{\hspace{1.0in}} l @{}}
Email: gabriel.fritsch@economics.ox.ac.uk & LinkedIn: \href{https://www.linkedin.com/in/gpfritsch/}{\texttt{linkedin.com/in/gpfritsch}} \\
Website: \href{https://www.gabrielpfritsch.com/}{\texttt{gabrielpfritsch.com}} & GitHub: \href{https://github.com/gabrielpfritsch}{\texttt{github.com/gabrielpfritsch}} \\
Citizenship: Brazil, Portugal (UK pre-settled status) & \\
\end{tabular}
...
% \vspace{1mm}
\normalsize
\noindent Member of Technical Staff, Mantic (London, UK) \hfill \begin{minipage}[t]{4cm}\raggedleft
2026--Present
\end{minipage}
...
\noindent Oxford Economics Papers (OEP) Fund \hfill \begin{minipage}[t]{6cm}\raggedleft
2025 \end{minipage}
...
\vspace{2mm}\normalsize
\noindent \textbf{2026:} Oxford PhD Seminar, NBER Summer Institute (International Finance and Macroeconomics)*

\vspace{0.5mm}
\noindent \textbf{2025:} Oxford PhD Seminar, Society for Economic Dynamics Annual Meeting*, European Central Bank
